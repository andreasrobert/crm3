...
MEDIA_ROOT = os.path.join(BASE_DIR, 'static/images')        # for image profile


#SMTP Configuration                     # for email stuff , google gmail smtp configuration for settup settings
